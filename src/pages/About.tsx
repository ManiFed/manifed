              ...
              <Card className="glass animate-slide-up">
                ...
                <CardContent className="space-y-4 text-muted-foreground">
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>
                      <strong className="text-foreground">Fintech:</strong> Various advanced tools to make your profit
                      graph skyrocket
                    </li>
                  </ul>
                  <p>Our mission is to make prediction markets more accessible, profitable, and fun for everyone.</p>
                </CardContent>
              </Card>
            ...
            <div className="space-y-6">
              ...
              <Card className="glass animate-slide-up" style={{ animationDelay: "200ms" }}>
                ...
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                  <p>For support or inquiries, reach out on Manifold or Discord.</p>
                  <p className="text-xs italic text-primary/70"></p>
                </CardContent>
              </Card>
            </div>
          </div>
