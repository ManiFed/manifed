    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <img
          src={trumpPortrait}
          alt=""
          className="absolute -right-10 top-32 w-[550px] h-auto opacity-[0.07] rotate-3"
        />
        <img
          src={trumpPortrait}
          alt=""
          className="absolute -left-20 bottom-20 w-[400px] h-auto opacity-[0.05] -rotate-6 scale-x-[-1]"
        />
        <img
          src={trumpPortrait}
          alt=""
          className="absolute right-1/3 top-2/3 w-[280px] h-auto opacity-[0.03] rotate-12"
        />
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center gap-3">
              <img
                alt="ManiFed"
                src="/lovable-uploads/2f4b846c-059e-4a08-a289-b1522b47cb1d.png"
      ...
      <main className="relative z-10">
        ...
        <section className="container mx-auto px-4 py-20 text-center space-y-8 relative">
          ...
          <div className="animate-slide-up">
            <img
              alt="ManiFed Chairman"
              src="/lovable-uploads/628bdfd0-48bf-45b8-b87b-952e8ff91924.png"
              className="w-40 h-40 mx-auto border-primary/50 mb-6 border-0 rounded-3xl shadow-xl"
            />
            ...
            <img
              alt="Signature"
              className="h-14 mx-auto mb-8 opacity-80"
              src="/lovable-uploads/dc5fca2b-4f00-4a11-a7fd-3c71e7c6374b.png"
            />
        ...
        <section className="container mx-auto px-4 py-16 relative">
          <img
            ...
            src="/lovable-uploads/7883cca7-f831-4eba-997b-1dcebfa165cf.png"
          />
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <img
                  ...
                  src="/lovable-uploads/221c5921-d422-4770-8cc9-8ad25e4bcd13.jpg"
                />
