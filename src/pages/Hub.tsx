    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <img
          src={trumpPortrait}
          alt=""
          className="absolute -right-16 top-40 w-[550px] h-auto opacity-[0.06] rotate-6"
        />
        <img
          src={trumpPortrait}
          alt=""
      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl relative z-10">
        ...
        <div className="mb-8 animate-slide-up relative">
          ...
          <p className="text-xs text-primary/70 mt-1 italic">
            "Many people are saying this is the best financial dashboard. Tremendous!" — DJT
          </p>
          <img
            alt="Signature"
            className="h-10 mt-2 opacity-70"
            src="/lovable-uploads/d5dd0dd7-cef1-46ac-8a1e-e2f260144ec8.png"
          />
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link to="/market-agent" className="group">
              <Card className="glass h-full hover:bg-card/90 transition-all hover:-translate-y-1 group-hover:border-primary/50">
                <CardHeader>
                  ...
                  <CardDescription>Paste a Manifold market link and ask AI questions about it.</CardDescription>
                </CardHeader>
                <CardContent>
                  <Button variant="outline" className="w-full group-hover:border-primary group-hover:text-primary">
                    Ask AI
            ...
            <Card className="glass h-full opacity-60 cursor-not-allowed">
              <CardHeader>
                ...
                <CardDescription>
                  Fixed-income instruments with guaranteed yields. Works like treasury bonds.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Collapsible>
              <Card className="glass h-full">
                <CardHeader>
                  ...
                  <CardDescription>Additional tools and features available on ManiFed.</CardDescription>
                </CardHeader>
                <CardContent>
