...
import {
  ArrowLeft, LogOut, Loader2, Play, Pause, ExternalLink,
  Calendar, Clock, DollarSign, CheckCircle, XCircle, Zap
} from 'lucide-react';
      ...
      <main className="container mx-auto px-4 py-8 max-w-2xl relative z-10">
        ...
        <div className="text-center mb-8 animate-slide-up">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Automatically buy and sell 1 share on the Quester market every day. 
            Perfect for staying active on Manifold!
          </p>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3 text-sm text-muted-foreground">
              ...
              <div className="flex gap-3">
                ...
                <p>This keeps you active on Manifold with minimal effort and cost!</p>
              </div>
            </div>
