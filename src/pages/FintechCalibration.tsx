...
export default function FintechCalibration() {
  ...
  const checkAccess = async () => {
    try {
      ...
      if (!user) {
        navigate('/auth?redirect=/fintech/calibration');
        return;
      }
        ...
        <Card className="glass max-w-md w-full">
          <CardHeader className="text-center">
            ...
            <CardDescription className="font-serif">
              Subscribe to ManiFed Fintech to access Calibration Analysis.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link to="/fintech">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <Link to="/fintech/menu" className="flex items-center gap-3">
              ...
              <span className="font-display text-lg font-bold text-foreground">Calibration Analysis</span>
            </Link>
