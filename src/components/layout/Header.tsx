...
import { Wallet, TrendingUp, PlusCircle, LayoutDashboard } from 'lucide-react';
import { cn } from '@/lib/utils';
import { mockUserPortfolio } from '@/data/mockLoans';

const navItems = [
  { path: '/', label: 'Marketplace', icon: TrendingUp },
        ...
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <h1 className="text-lg font-bold text-gradient">ManiFund</h1>
              <p className="text-xs text-muted-foreground -mt-0.5">Loan Marketplace</p>
            </div>
          </Link>
