      ...
      <DialogContent className="sm:max-w-md">
        ...
        <Tabs defaultValue="usd" className="mt-4">
          ...
          <TabsContent value="usd" className="space-y-4 mt-4">
            ...
            <Button variant="glow" className="w-full" onClick={handleUsdDonate} disabled={isLoading}>
              {isLoading ? <Loader2 className="w-4 h-4 animate-spin mr-2" /> : <Heart className="w-4 h-4 mr-2" />}
              Donate ${usdAmount || "0"}
            </Button>
          </TabsContent>
          ...
          <TabsContent value="mana" className="space-y-4 mt-4">
            ...
            <div className="space-y-3 p-3 rounded-lg bg-secondary/30 border border-border/50">
              ...
              <div className="flex gap-2">
                <Button variant="outline" size="sm" onClick={handleCopyMessage} className="flex-1 gap-2">
            ...
            <a href="https://manifold.markets/ManiFed" target="_blank" rel="noopener noreferrer" className="block">
